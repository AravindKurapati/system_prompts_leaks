...
## Canonical file paths (one per model)
- claude:  Anthropic/claude.html
- openai:  OpenAI/GPT-4o.md  (may not exist yet — skipped with warning)
...
- COMPLIANCE_SIGNALS are strict-only (explicit reveals/DAN). Broad affirmations removed to avoid false positives.
